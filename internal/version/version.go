// Package version carries pare's build identity. Version/Commit/Date are
...
// Info is the structured build identity, emitted by `pare version --json`.
type Info struct {
